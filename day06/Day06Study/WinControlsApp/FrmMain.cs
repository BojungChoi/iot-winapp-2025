namespace WinControlsApp
{
    public partial class FrmMain : Form
    {
        ...
        private void ChangeFont()
        {
            ...
            if (ChkBold.Checked) style |= FontStyle.Bold; // FontStyle.Regular | FontStyle.Bold => 0000 | 0001 = 0001 -> Bold 체
        ...
        {
            int value = TrbProcess.Value;
            PrgProcess.Value = value;

            FntTrack.Text = $"진행도 : {value} 빠센또 ";

            if (value < 30)
                FntTrack.ForeColor = Color.Red;
            else if (value < 50)
                FntTrack.ForeColor = Color.Orange;
            else if (value < 70)
                FntTrack.ForeColor = Color.Blue;
            else
                FntTrack.ForeColor = Color.LimeGreen;
        }
        ...
        private void BtnModal_Click(object sender, EventArgs e)
        {
            ...
            frmModal.Width = 300;
            frmModal.Height = 100;
            frmModal.BackColor = Color.OrangeRed;
        ...
        private void BtnModaless_Click(object sender, EventArgs e)
        {
            ...
            frmModaless.StartPosition = FormStartPosition.Manual;    // 부모창의 정중앙
            ...
            frmModaless.Show(this); // 모달리스 창띄우기
        }

        private void BtnMsgBox_Click(object sender, EventArgs e)
        {
            // 메시지박스 -> 모달창
            MessageBox.Show(TxtResult.Text, "텍스트박스문장", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }
        ...
        private void LsvDummy_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void BtnOpenImage_Click(object sender, EventArgs e)
        {
            ...
            if (DlgOpenImage.ShowDialog() == DialogResult.OK)
            {
                ...
                PicImage.SizeMode = PictureBoxSizeMode.Zoom;    // PictureBoxSizeMode.Zoom
            }
        }
