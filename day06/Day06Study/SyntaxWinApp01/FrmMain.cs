...
namespace SyntaxWinApp01
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            BgwProcess.ProgressChanged += BgwProcess_ProgressChanged; // 백그라운드 진행상태 변경 이벤트
        ...
        private void BgwProcess_ProgressChanged(object? sender, ProgressChangedEventArgs e)
        {
            ...
            int currVal = (int)e.UserState; // ReportProgrss 2번으로 넘어온 값
        ...
        private void BgwProcess_DoWork_1(object sender, DoWorkEventArgs e)
        {
